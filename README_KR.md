...
ABF와 프로그램을 제작한 사람은 단순히 취미활동으로서 프로그래밍을 하는 사람으로, 소스코드가 읽기 복잡하거나 버그가 있을 수 있습니다. 아래의 설명은 모두 MS Windows 환경에서 테스트한 것입니다. 참고: Debian 환경에서 gcc로 빌드했을 때 정상적으로 작동하는 것을 확인했습니다.
