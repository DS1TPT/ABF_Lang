...
#error [WARNING] OS is not Windows or *nix.
#endif
#include <stdio.h>
...
int64_t roundftoll(double* pDb); /* round double and cast it to int, then return int value */
