...
#define CHAR_MIN 0
#define CHAR_MAX 255
#define SIGNED_CHAR_AVAILABLE FALSE
#define INT_SIZE 2
#define DBL_SIZE 5
...
#define CHAR_MIN -128
#define CHAR_MAX 127
#define SIGNED_CHAR_AVAILABLE TRUE
...
main() {
    char rtnVal = 0;
    BOOL isUnbalanced = FALSE;
    if (isC64) printf("%c", 14); /* PETSCII ctrl char, use char set 2(upper/lower case) */
    ...
    printf("Signed char %s\n", SIGNED_CHAR_AVAILABLE ? "available" : "unavailable");
