...
int main() {
    ...
    initGlobalVar();
    puts("Ascii BrainFuck Language Interpreter Prompt v1.00b");
...
void help() {
    ...
    puts("Interpreter settings commands");
    puts("--bf : interpret BrainFuck Program");
    puts("--abf: interpret Ascii BrainFuck Program");
    puts("--hexadecimal : print integer in hexadecimal");
    puts("--decimal : print integer in decimal");
    puts("--binary : print integer in binary");
